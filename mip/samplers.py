...
def get_default_step_list(loss_type: str):
    ...
    elif loss_type in ["regression", "mip", "tsd", "vla_mip", "mip_render"]:
        return [1]
    else:
...
def get_sampler(loss_type: str):
    ...
    elif loss_type in ["tsd", "mip", "vla_mip", "mip_render"]:
        return mip_sampler
...
def ode_sampler(
    ...
    if sample_mode == "stochastic":
        act_s = act_0  # use caller-provided noise for diversity across samples
    else:
